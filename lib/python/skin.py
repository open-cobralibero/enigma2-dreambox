...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "skins-cobra-fhd/skin.xml" or "cobra-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
