...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "cobra-fhd/skin.xml" or "skins-cobra-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
